...
Copy-Item -Path ".\ç°ì˙ÇÃó\íË.ps1" -Destination "C:\MiraieDigital\99_CommonTools"

# Copy ç°ì˙ÇÃó\íË.bat to Desktop
$desktopPath = [System.Environment]::GetFolderPath('Desktop')
Copy-Item -Path ".\ç°ì˙ÇÃó\íË.bat" -Destination $desktopPath
